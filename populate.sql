...
insert into users (username, password, email, biography, pfp, is_deleted) values ('estannislawski1', 'Xuml2pE', 'cwork1@adobe.com', 'Business-focused exuding encoding', 7519, false);
