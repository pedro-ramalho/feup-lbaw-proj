...
insert into post (id, id_community, id_tag, title, is_image) values (1, 2, 1, 'Scusa ma ti chiamo amore', false);
insert into post (id, id_community, id_tag, title, is_image) values (2, 4, 2, 'Citizen Kane', false);
insert into post (id, id_community, id_tag, title, is_image) values (3, 7, 3, 'Big Star: Nothing Can Hurt Me', false);
insert into post (id, id_community, id_tag, title, is_image) values (8, 9, 4, 'Together (Tillsammans)', true);
insert into post (id, id_community, id_tag, title, is_image) values (16, 10, 5, 'Grand Seduction, The', false);
insert into post (id, id_community, id_tag, title, is_image) values (18, 1, 6, 'Chechahcos, The', true);
insert into post (id, id_community, id_tag, title, is_image) values (19, 20, 7, 'Ninette', false);
insert into post (id, id_community, id_tag, title, is_image) values (24, 17, 8, 'Babadook, The', false);
insert into post (id, id_community, id_tag, title, is_image) values (25, 19, 9, 'While the City Sleeps', false);
insert into post (id, id_community, id_tag, title, is_image) values (26, 16, 10, 'Trespass', false);
insert into post (id, id_community, id_tag, title, is_image) values (29, 10, 11, 'Sammy and Rosie Get Laid', false);

insert into text_post (id, text) values (1, 'Realigned secondary analyzer');
insert into text_post (id, text) values (2, 'Ameliorated well-modulated flexibility');
insert into text_post (id, text) values (3, 'Operative well-modulated intranet');
insert into text_post (id, text) values (16, 'Decentralized explicit knowledge user');
insert into text_post (id, text) values (19, 'Object-based executive complexity');
insert into text_post (id, text) values (24, 'Upgradable motivating system engine');
insert into text_post (id, text) values (25, 'Advanced neutral access');
insert into text_post (id, text) values (26, 'Streamlined heuristic concept');
insert into text_post (id, text) values (29, 'Re-engineered mission-critical software');
...
insert into image_post (id, id_image) values (1, 8);
insert into image_post (id, id_image) values (2, 18);

insert into favorite_post (id_post, id_user) values (1, 20);
insert into favorite_post (id_post, id_user) values (1, 30);
insert into favorite_post (id_post, id_user) values (2, 22);
insert into favorite_post (id_post, id_user) values (2, 11);
insert into favorite_post (id_post, id_user) values (3, 29);
insert into favorite_post (id_post, id_user) values (8, 3);
insert into favorite_post (id_post, id_user) values (16, 29);
insert into favorite_post (id_post, id_user) values (18, 6);
insert into favorite_post (id_post, id_user) values (19, 7);
insert into favorite_post (id_post, id_user) values (24, 13);
insert into favorite_post (id_post, id_user) values (24, 1);
insert into favorite_post (id_post, id_user) values (24, 22);
insert into favorite_post (id_post, id_user) values (25, 9);
insert into favorite_post (id_post, id_user) values (26, 24);
insert into favorite_post (id_post, id_user) values (29, 4);
