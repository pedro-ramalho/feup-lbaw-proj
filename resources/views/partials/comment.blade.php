<article class="comment">
  ...
  <section class="comment-content">
    ...
    <section class="comment-interactables">
      ...
      <form method="POST" action="{{ route('reply', $comment->id) }}" class="reply flex justify-center gap-x-2">
          {{ csrf_field() }}
          ...
          <button type="submit" class="p-1 rounded-md h-2/4 bg-gray-700 text-white font-medium hover:cursor-pointer hover:bg-gray-800 self-end">Reply</button>
      </form>
    </section>
